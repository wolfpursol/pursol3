...
public class ChineseSpelling {   
    ...
    public static String getFirstWord(String chs) {
		String str = getSpell(chs,true);
		String word = "";
		str = str.trim();
		if(str.length() > 0){
			word = str.substring(0,1).toUpperCase();
		}
		return word;
	}
    ...
    public static void main(String[] args) {   
        ...
        for (int i = 0; i < s.length; i++) {   
            ...
            System.out.println("全拼:" + getSpell(s[i], false));   
            System.out.println("首拼:" + getSpell(s[i], true));   
            System.out.println("首字母:" + getFirstWord(s[i]));   
